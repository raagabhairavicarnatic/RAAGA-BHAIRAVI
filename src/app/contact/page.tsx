        ...
        >
            ...
            <div className="space-y-6 text-sm">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:raagabhairavi.carnatic@gmail.com" className="text-text-secondary hover:text-primary transition-colors break-all sm:break-normal">
          ...
          <div className="glass-panel p-3 rounded-3xl overflow-hidden shadow-sm h-full min-h-[350px]">
            <iframe
              ...
              src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d458.3741655328086!2d80.29992037818903!3d13.159617001139003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTPCsDA5JzM1LjUiTiA4MMKwMTcnNTkuOCJF!5e0!3m2!1sen!2sin!4v1781182355634!5m2!1sen!2sin"
              className="w-full h-full rounded-2xl border-0 min-h-[350px]"
              allowFullScreen
              loading="lazy"
